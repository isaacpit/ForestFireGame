...
public class WowCamera : MonoBehaviour
{
	...
	void LateUpdate ()
	{
		...
		if (GUIUtility.hotControl == 0 && Time.timeScale == 1) {
        ...
        //Set the Player Rotation to always be forward respective to the camera
        target.rotation = Quaternion.Euler(target.rotation.y, xDeg, 0);
